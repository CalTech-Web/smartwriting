    ...
    <>
      ...
      <section className="bg-gradient-to-br from-primary to-primary-light hero-gradient-animated text-white py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h1 className="hero-text-reveal text-4xl md:text-5xl font-bold mb-4">Let&apos;s Talk!</h1>
          <p className="hero-text-reveal-delay-1 text-gray-200 text-lg">
            ...
            <div>
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="bg-bg-light rounded-2xl p-8 shadow-sm space-y-5">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-accent text-white py-3 rounded-full font-semibold text-lg hover:bg-accent-hover transition-colors shadow-md btn-glow"
                  >
                    Send Message
                  </button>
                </form>
